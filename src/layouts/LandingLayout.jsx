    ...
    <div>
      ...
      <div className={styles.footerImage}>
        ...
        <div className={styles.footerSection}>
          <h3>Menú</h3>
          <ul>
            <Link className={styles.navlinkfoot} to="/"><li>Inicio</li></Link>
            <Link className={styles.navlinkfoot} to="/about"><li>Nosotros</li></Link>
            <Link className={styles.navlinkfoot} to="/products"><li>Productos</li></Link>
            <Link className={styles.navlinkfoot} to="/contact"><li>Contacto</li></Link>
          </ul>
        </div>
        <div className={styles.footerSection}>
          <h3>Contacto</h3>
          <p>Correo: <a href="mailto:dania.montesdeoca@vpcapital.mx">EDUARDOREZNIK@CINTAMEX.COM.MX</a></p>
          <p>Teléfono: <a href="tel:+525543903252">(+52) 55 8556 7960</a></p>
